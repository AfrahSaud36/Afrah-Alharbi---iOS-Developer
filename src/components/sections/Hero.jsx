    ...
    return (
        <section id="home" className="min-h-screen flex items-center pt-20">
            <div className="grid md:grid-cols-2 gap-10 items-center w-full">
                ...
                >
                    <h2 className="text-2xl font-medium text-white mb-2">{t.hero.hello}</h2>
                    <h1 className="text-5xl md:text-7xl font-bold text-white mb-4">Afrah Alharbi</h1>
                    <div className="text-2xl md:text-3xl font-bold text-white mb-6 flex gap-2">
                        <span>{t.hero.im}</span>
                        <Typewriter
                    ...
                    <div className="flex gap-4">
                        ...
                        <a href="tel:+966506025451" className="p-2 bg-gray-800 rounded-full hover:bg-primary hover:text-black transition-all transform hover:-translate-y-1">
                            <img src="/images/phone icon.png" alt="Phone" className="w-8 h-8" />
                        </a>
